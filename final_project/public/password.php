<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $old = CS50::query("SELECT password FROM users WHERE id = ?", $_SESSION["id"]);
        ...
        {
            CS50::query("UPDATE users SET password = ?", password_hash($_POST["new"], PASSWORD_DEFAULT));
            render("password_display.php");
        }
    }
    else
    {
